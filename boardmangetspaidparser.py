#!/usr/bin/env python3
"""
EasyStats HTML to JSON Parser - Board Man Gets Paid Basketball
Completely standalone parser for Board Man Gets Paid team
"""
...
# ============================================
# TEAM CONFIGURATION - BOARD MAN GETS PAID
# ============================================
TEAM_NAME = 'Board Man Gets Paid'
TEAM_SLUG = 'board-man-gets-paid'
TEAM_VARIANTS = ['board man gets paid', 'board-man-gets-paid', 'boardmangetspaid', 'board man', 'boardman']
DATA_DIR = 'data/test teams/board-man-gets-paid'
# ============================================
