#!/usr/bin/env python3
"""
EasyStats HTML to JSON Parser - Just Jokic-ing Basketball
Completely standalone parser for Just Jokic-ing team
"""
...
# ============================================
# TEAM CONFIGURATION - JUST JOKIC-ING
# ============================================
TEAM_NAME = 'Just Jokic-ing'
TEAM_SLUG = 'just-jokic-ing'
TEAM_VARIANTS = ['just jokic-ing', 'just-jokic-ing', 'justjokicing', 'jokic-ing', 'jokicing']
DATA_DIR = 'data/test teams/just-jokic-ing'
# ============================================
