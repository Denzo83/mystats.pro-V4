#!/usr/bin/env python3
"""
EasyStats HTML to JSON Parser - All Stars Basketball
Completely standalone parser for All Stars team
"""
...
# ============================================
# TEAM CONFIGURATION - ALL STARS
# ============================================
TEAM_NAME = 'All Stars'
TEAM_SLUG = 'all-stars'
TEAM_VARIANTS = ['all stars', 'all-stars', 'allstars', 'all star', 'allstar']
DATA_DIR = 'data/all-stars'
# ============================================
